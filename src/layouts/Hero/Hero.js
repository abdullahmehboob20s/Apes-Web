        ...
        <div className="hero">
          <div className="hero-left">
            ...
            <p className="fs-22px darkest-blue lh-34px mb-35px">
              ...
              digital collectibles. These apes love boba tea so much, they have
              decided to make Boba Network their home. Each BobaApe is unique,
              and programmatically generated from X possible traits. These
              traits include clothing, background, headwear, accessories and
              more. The apes exist on Boba Network as ERC-721 tokens, and have
              their metadata hosted on IPFS.
            </p>
